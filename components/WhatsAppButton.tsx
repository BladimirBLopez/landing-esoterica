...
export default function WhatsAppButton({
  ...
  return (
    <a
      ...
      className={`group relative inline-flex items-center gap-3 rounded-full border-2 border-[#c9a24b] bg-gradient-to-b from-[#3d1414] to-[#1a0505] pl-2 pr-6 py-2 text-sm font-semibold uppercase tracking-wider text-[#f5e6d3] shadow-[0_0_18px_-4px_rgba(201,162,75,0.6)] transition-all duration-300 hover:border-[#e6c476] hover:shadow-[0_0_28px_-2px_rgba(201,162,75,0.9)] ${className}`}
    >
      <span className="flex h-9 w-9 shrink-0 items-center justify-center rounded-full bg-[#c9a24b] transition-transform duration-300 group-hover:scale-105">
        <svg viewBox="0 0 32 32" className="h-5 w-5 fill-[#1a0505]">
