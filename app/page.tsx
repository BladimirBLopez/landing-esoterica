  ...
  return (
    <main className="min-h-screen bg-[#1a0505] text-[#f5e6d3]">
      ...
      <section className="relative flex min-h-screen flex-col items-center justify-center gap-4 overflow-hidden px-6 py-24 text-center">
        ...
        <div className="absolute right-0 top-0 z-10 h-44 w-60 opacity-50 drop-shadow-lg">
          <Image
        ...
        <div className="relative z-10 flex flex-col items-center gap-4">
          ...
          />
          <a href={`tel:+${NUMERO}`} className="text-3xl font-bold tracking-wide text-[#c9a24b] drop-shadow-lg hover:text-[#f0d78c] sm:text-4xl">
            📞 {TELEFONO_VISIBLE}
          </a>
        </div>
